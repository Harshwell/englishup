...
Acceptance criteria: Gemini gateway has timeout, retry, circuit breaker, prompt-version cache keys, Zod validation, latency/failure logging, and specific fallback reasons. Keep expanding free API enrichment before adding secondary AI providers.
